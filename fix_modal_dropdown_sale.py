...
old_select = """                                <select
                                    ...
                                    className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-3 text-xs font-black text-slate-900 dark:text-white outline-none focus:border-indigo-600 cursor-pointer"
                                >
                                    <option value="">-- بدون موزع (موزع نقدي عام) --</option>
...
searchable = """                                <SearchableSelect
                                    ...
                                    placeholder="-- بدون موزع (موزع نقدي عام) --"
