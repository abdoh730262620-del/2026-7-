const fs = require('fs');
let content = fs.readFileSync('src/pages/Purchases.tsx', 'utf8');

const invalidBlock = `{!isSalesFocusMode && (
                  
<div className="flex bg-bg-main rounded-xl p-0.5 border border-border-main shadow-sm w-max shrink-0">`;
